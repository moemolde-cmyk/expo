...
public final class WorkletIntegration: NSObject {
  @objc public static func register() {
    ...
    AppContext.uiRuntimeFactory = WorkletsUIRuntimeFactoryImpl(provider: provider)
  }
}
...
internal final class WorkletsUIRuntimeFactoryImpl: NSObject, WorkletsUIRuntimeFactory {
